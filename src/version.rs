...
#[allow(clippy::doc_markdown)] // generated by the `built` crate
pub mod built_info {
...
impl VersionInfo {
    ...
    pub fn short_version(&self) -> String {
        ...
        // No usable git-describe info: fall back to the short commit hash
